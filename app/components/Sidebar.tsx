...
export function Sidebar({ siteName, navigation, socialLinks }: SidebarProps) {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-56 flex flex-col justify-between p-8 bg-white dark:bg-gray-950 border-r border-gray-100 dark:border-gray-900 z-50">
      {/* Site Name */}
      <div>
  ...
  return (
    <Link
      ...
      className={`
        ...
        ${isChild ? "text-gray-500 dark:text-gray-500" : ""}
