...
export async function getHomePhotosFromIndex(
  ...
  // Existing v9 indexes predate dimensions on featuredPhotos, while the same
  // values already live in galleryData. Enrich at read time so the home grid is
  // stable immediately, without forcing an expensive R2 index rebuild.
