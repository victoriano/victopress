...
export async function loader({ request, context }: LoaderFunctionArgs) {
  ...
  // If already fully configured (R2 + credentials), redirect to admin
  // Unless in dev mode or force access
  if (!isDev && !forceAccess && storageConfigured && env?.ADMIN_USERNAME) {
    console.log("[Setup Wizard] Redirecting to /admin - already configured");
