      ...
      <div className="p-6 lg:p-8 max-w-4xl">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            <Link
              to={defaultGallery ? `/admin/galleries/${defaultGallery}` : "/admin/galleries"}
          ...
          <nav className="flex items-center gap-1 text-sm ml-1">
            <Link 
              to="/admin/galleries"
            ...
            {defaultGallery && (
              <>
                ...
                <Link
                  to={`/admin/galleries/${defaultGallery}`}
                  className="text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors"
                >
                  {galleries.find(g => g.slug === defaultGallery)?.title || defaultGallery}
                </Link>
              </>
            )}
            <ChevronRightSmallIcon />
